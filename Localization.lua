...
L["Current Squire2 profile: %s"] = true
...
L["Alt+Click to invert them all,"] = "Alt+clic pour les inverser,"
...
L["Ctrl+Click to bring them all and in the darkness bind them."] = "Ctrl+clic pour les amener tous et dans les ténèbres les lier."
L["Current Squire2 profile: %s"] = "Profil Squire2 actuel : %s"
...
L["Settings"] = "Réglages"
L["Shift+Click to check them all,"] = "Maj-clic pour les cocher tous,"
L["Squire2"] = "Squire2"
L["Strict ground mounts"] = "Montures terrestres strictes"
L["This mount is not listed by LibMounts-1.0. Squire2 cannot use it."] = "Cette monture n'est pas prise en charge par LibMounts-1.0. Squire2 ne peut pas l'utiliser."
L["Toggle Mount Journal"] = "Montures"
...
L["Warning: the following keys are already bound: %s"] = "Attention : les touches suivantes sont déjà assignées : %s"
...
L["Alt+Click to invert them all,"] = "Alt-clic para invertir todos las selecciones,"
L["Any"] = "Cualquier"
L["Bindings"] = "Teclados"
...
L["Ctrl+Click to bring them all and in the darkness bind them."] = "Ctrl-click para deseleccionar todos."
L["Current Squire2 profile: %s"] = "Perfil actual: %s"
...
L["Settings"] = "Opciones"
L["Shift+Click to check them all,"] = "Mayús-click para seleccionar todos,"
L["Squire2"] = "Squire2"
L["Strict ground mounts"] = "Sólo monturas terrestres"
L["This mount is not listed by LibMounts-1.0. Squire2 cannot use it."] = "Este montura no está en la lista de LibMounts-1.0. Squire2 no puede utilizarlo."
L["Toggle Mount Journal"] = "Mostrar/ocultar guía de monturas"
...
L["Warning: the following keys are already bound: %s"] = "Aviso: Estos teclas ya están asignadas: %s"
